			...
			if(pass == conf_pass)
			{
				try{
					...
					var mailOptions = {
						from: webEmail,
						to: email,
						subject: 'Account successfully created | On Binance-Uganda',
						html: '<p>Dear <b>'+username+',</b></p><p>Your account successful added at Binance-Uganda</p><p>Email: '+email+'<br>Password: '+pass+'</p><p>thanks and regards,<br>Binance-Uganda</p>'
					};
...
router.get('/userReferral', async (req, res) => {
	...
	if(emailId)
	{
		...
		res.render('userReferral', {title: "Referral Users", menuId: "userReferral", userList_arr: user_list, reference_user_arr: reference_user, msg: notification_arr, adminname:admin_name});
	}
	else
	{
		var notification_arr = {
...
router.get("/users/:page", async (req, res) => {
	...
	if(emailId)
	{
		...
		try{
			...
			res.render('users', { title: 'User Management', menuId: 'users', msg: notification_arr, adminname:admin_name, users_list: users_list, currentPage: page, pages: pages });			
		}
		catch(error)
		{
			throw new Error(err);
	...
	if(emailId)
	{
		try{
			...
			if(edituser_arr != '')
			{
				...
				res.render('userDetails', { title: 'User Management', menuId: 'users', msg: notification_arr, adminname:admin_name, edituser_arr: edituser_arr, referral_userlist: referral_userlist, reference_userdetails: reference_userdetails, evotbonus_arr: evotbonus_arr, userid_bonus: userid_bonus, user_paidbonus: user_paidbonus, usergroup_arr: usergroup_arr});
			}
			else
			{
				...
				res.render('users', { title: 'User Management', menuId: 'users', msg: notification_arr, adminname:admin_name, users_list: users_list });
			}
		}
		catch(error)
		{
...
router.get("/adduser", async (req, res) => {
	...
	if(emailId)
	{
		...
		var form = '';
		res.render('adduser', { title: 'Add User', menuId: 'users', msg: notification_arr, form:form, adminname:admin_name});
	}
	else
	{
		var notification_arr = {
		...
		if(pass != '' && conf_pass != '' && username != '' && email != '' && eth_address != '')
		{
			if(username)
			{
				...
				if (validusername == false) {
					...
					res.render('adduser', { title: 'Add User', menuId: 'users', msg: notification_arr, adminname:admin_name, form:form });
				}
...
router.get('/userrole', async (req, res) => {
	...
	if(emailId)
	{
		...
		res.render('usersrole', {title: 'User Role', menuId: 'usersrole', msg: notification_arr, adminname: admin_name, role_list: role_list});
	}
	else
	{
		var notification_arr = {
...
router.get('/adduserrole', async (req, res) => {
	...
	if(emailId)
	{
		...
		res.render('usersrole', {title: 'User Role', menuId: 'usersrole', msg: notification_arr, adminname: admin_name });
	}
	else
	{
		var notification_arr = {
...
router.get("/edituserrole/:postID", async (req, res) => {
	...
	if(emailId)
	{
		...
		try {
			...
			res.render('editUserRole', { title: 'Edit User Role', menuId: 'usersrole', msg: notification_arr, adminname:admin_name, edit_role: edit_role });
		}
		catch(error)
		{
			var notification_arr = {
...
router.get("/blogs", async (req, res) => {
	...
	if(emailId)
	{
		...
		res.render('blogs', { title: 'Blog', menuId: 'blogs', msg: notification_arr, adminname:admin_name, blog_result: blog_result });					
	}
	else
	{
		var notification_arr = {
...
router.get("/addblog", async (req, res) => {
	...
	if(emailId)
	{
		...
		res.render('addblog', { title: 'Add Blog', menuId: 'blogs', msg: notification_arr, adminname:admin_name, category_result: category_result });
	}
	else
	{
		var notification_arr = {
				...
				if(category_arr.length > 0)
				{
					if(req.file)
					{
						...
						else
						{
							...
							res.render('addblog', { title: 'Add blogs', menuId: 'blogs', msg: notification_arr, adminname:admin_name, category_result: category_result });
						}							
					}
					else
					{
	...
	if(emailId)
	{
		...
		if(edit_blogs)
		{
			...
			try{
				...
				res.render('editblog', { title: 'Edit blog', menuId: 'blogs', msg: notification_arr, adminname:admin_name, edit_blogs: edit_blogs, selected_cat: selected_cat_arr, category_result: category_result });					
			}
			catch(error)
			{
				var notification_arr = {
...
router.get("/category", async (req, res) => {
	...
	if(emailId)
	{
		...
		res.render('category', { title: 'Category', menuId: 'blogs', msg: notification_arr, adminname:admin_name, category_result: category_result});					
	}
	else
	{
		var notification_arr = {
...
router.get("/addcategory", async (req, res) => {
	...
	if(emailId)
	{
		...
		res.render('addcategory', { title: 'Add Category', menuId: 'blogs', msg: notification_arr, adminname:admin_name });
	}
	else
	{
		var notification_arr = {
...
router.get("/editcategory/:postID", async (req, res) => {
	...
	if(emailId)
	{
		...
		try{
			...
			res.render('editcategory', { title: 'Edit Category', menuId: 'blogs', msg: notification_arr, adminname:admin_name, edit_category: edit_category });					
		}
		catch(error)
		{
			var notification_arr = {
...
router.get('/user_groups', async (req, res) => {
	...
	if(emailId)
	{
		...
		res.render('userGroups', {title: 'User Groups', menuId: 'userGroups', msg: notification_arr, adminname: admin_name, group_result: group_result});
	}
	else
	{
		var notification_arr = {
...
router.get('/addgroup', async (req, res) => {
	...
	if(emailId)
	{
		...
		res.render('userGroups', {title: 'User Groups', menuId: 'userGroups', msg: notification_arr, adminname: admin_name});
	}
	else
	{
		var notification_arr = {
...
router.get("/editgroup/:postID", async (req, res) => {
	...
	if(emailId)
	{
		...
		try {
			...
			res.render('editUserGroups', { title: 'Edit User Groups', menuId: 'userGroups', msg: notification_arr, adminname:admin_name, edit_group: edit_group });
		}
		catch(error)
		{
			var notification_arr = {
